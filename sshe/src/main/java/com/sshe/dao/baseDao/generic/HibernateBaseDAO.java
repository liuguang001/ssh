...
public class HibernateBaseDAO extends HibernateDaoSupport {
	...
	public void setMySessionFactory(SessionFactory mySessionFactory) {
		...
		if(mySessionFactory != null) {
			searchProcessor = HibernateSearchProcessor.getInstanceForSessionFactory(mySessionFactory);
			metadataUtil = HibernateMetadataUtil.getInstanceForSessionFactory(mySessionFactory);
		}
	}
