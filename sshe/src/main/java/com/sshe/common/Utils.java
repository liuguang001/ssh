...
//	private static final DateFormat df_nosplit = new SimpleDateFormat("yyyyMMddHHmmss"); // 存在线程不安全隐患,特此弃之  改用 joda-time
	...
	private static final String[] TEL_TELECOM = {"133","153","189","180","181","177","170","173","199"};
